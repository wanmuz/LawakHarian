...
When I fill in "Email" with "newguy@lawakharian.com"
And I press "Update User"
Then I should see "User has been updated."
And I should see "newguy@lawakharian.com"
And I should not see "user@lawakharian.com"

Scenario: Toggling a user's admin ability
When I check "Is an admin?"
And I press "Update User"
Then I should see "User has been updated."
And I should see "user@lawakharian.com (Admin)"
